...
class RefreshImage extends Component {
  ...
  async getImage() {
    ...
    const url = `https://api.unsplash.com/photos/random?orientation=landscape&per_page=1&query=${this.props.city}&client_id=itYr7KREbu7JyO7fDItL2-vArBJiFu2RbuqWTN0Wmn8`;
