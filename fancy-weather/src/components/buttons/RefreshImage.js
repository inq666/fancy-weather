...
class RefreshImage extends Component {
  ...
  async getImage() {
    const url = `https://api.unsplash.com/photos/random?orientation=landscape&per_page=1&query=${this.props.city}&client_id=az7S4SlATqhmXPZnCGBqhaooohw6HpycUrkCwIp_-ZU`;
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="refresh-image" onClick={() => this.getImage()}>
          <svg className="refresh__icon" width="54px" height="54px" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
